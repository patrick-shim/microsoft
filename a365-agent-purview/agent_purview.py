...
"""
agent_purview.py — the a365-agent-slim demo + Microsoft Purview DLP on prompts.
...
Usage (inside the project venv):
    ...
    .venv/Scripts/python.exe agent_purview.py                       # interactive chat (REPL)
    .venv/Scripts/python.exe agent_purview.py -m "Give me a tip"    # one turn, then exit
    .venv/Scripts/python.exe agent_purview.py --no-export           # chat only, skip A365 export
